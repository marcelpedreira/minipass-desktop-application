...
public:
    ...
    void retranslateUi(QDialog *newControllerDialog)
    {
        ...
        typeComboBox->insertItems(0, QStringList()
         << QApplication::translate("newControllerDialog", "Puertas", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("newControllerDialog", "Entradas/Salidas", 0, QApplication::UnicodeUTF8)
        );
    } // retranslateUi
